...
public class HttpRequestMessage {
	...
	public HttpRequestMessage(HttpMethod method, String url, Authorization auth) {
		this(method, url, auth, null);
	}

	public HttpRequestMessage(HttpMethod method, String url, Authorization auth, Map<String, Object> parameters) {
		if (url == null){
